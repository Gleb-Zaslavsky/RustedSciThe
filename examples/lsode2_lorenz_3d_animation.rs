...
//!
//! Goal:
//! solve the Lorenz system with LSODE2 and visualize the full trajectory
//! with the native 3D animation helper.
//!
//! This mirrors the existing animation example but uses the LSODE2 builder
//! API instead of the legacy BDF constructor.
//!
//! run cargo run --example lsode2_lorenz_3d_animation
