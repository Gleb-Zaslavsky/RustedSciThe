//! Ручной выбор семейства LSODE2 (только BDF)
//!
//! Зачем:
//! в workflows типа LSODE часто нужен явный контроль метода.
//! Этот гайд показывает, как принудительно выбрать семейство BDF.
//! 
//! 
//! запуск: cargo run --example lsode2_manual_bdf_guide
//!
...
fn main() {
    // Умеренно жёсткая система 2x2, удобная для короткого примера.
    ...
    // или .with_controller(Lsode2ControllerConfig::bdf_only())
    // Faithful native BDF stepping path.
