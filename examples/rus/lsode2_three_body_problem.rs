//! LSODE2: задача трёх тел
//!
//! Цель:
//! решить классическую гравитационную задачу трёх тел через LSODE2 с
//! жёсткими допусками и визуализировать траекторию первого тела в 2D.
//!
//! Этот пример сохраняет исходную физику из `three_body_problem.rs`, но
//! переводит её на современный LSODE2 builder-style API.
//!
//! Запуск:
