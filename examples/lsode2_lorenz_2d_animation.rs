...
//!
//! Goal:
//! solve the Lorenz system with LSODE2 and visualize the X-Y projection using
//! the native 2D animation helper.
//!
//! This keeps the same familiar animation workflow as the existing BDF
//! example, but routes the IVP through the modern LSODE2 builder-style API.
//!
//! run cargo run --example lsode2_lorenz_2d_animation
