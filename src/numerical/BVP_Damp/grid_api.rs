...
use crate::numerical::BVP_Damp::adaptive_grid_basic::{
    easy_grid_refinement_par, grcar_smooke_grid_refinement, pearson_grid_refinement_par,
    refine_all_grid_par, scipy_grid_refinement,
};
...
pub fn new_grid(
    ...
    match method {
        ...
        GridRefinementMethod::Easy(tolerance) => {
            easy_grid_refinement_par(y_DMatrix, x_mesh, tolerance)
        }
