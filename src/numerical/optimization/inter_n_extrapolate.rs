...
mod tests {
    ...
    fn test_lagrange_linear_interpolation() {
        ...
        assert_relative_eq!(lagrange_interpolate(0.0, &x_vals, &y_vals), 1.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(1.0, &x_vals, &y_vals), 3.0, epsilon = 1e-10);

        // Test interpolation
        assert_relative_eq!(lagrange_interpolate(0.5, &x_vals, &y_vals), 2.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(2.0, &x_vals, &y_vals), 5.0, epsilon = 1e-10);
    }
    ...
    fn test_lagrange_quadratic_interpolation() {
        ...
        // Test at known points
        assert_relative_eq!(lagrange_interpolate(0.0, &x_vals, &y_vals), 1.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(1.0, &x_vals, &y_vals), 0.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(2.0, &x_vals, &y_vals), 1.0, epsilon = 1e-10);

        // Test interpolation and extrapolation
        assert_relative_eq!(lagrange_interpolate(0.5, &x_vals, &y_vals), 0.25, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(1.5, &x_vals, &y_vals), 0.25, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(3.0, &x_vals, &y_vals), 4.0, epsilon = 1e-10);
    }
    ...
    fn test_lagrange_cubic_interpolation() {
        ...
        // Test at known points
        assert_relative_eq!(lagrange_interpolate(0.0, &x_vals, &y_vals), -6.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(1.0, &x_vals, &y_vals), 0.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(2.0, &x_vals, &y_vals), 0.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(3.0, &x_vals, &y_vals), 0.0, epsilon = 1e-10);

        // Test interpolation
        assert_relative_eq!(lagrange_interpolate(1.5, &x_vals, &y_vals), 0.375, epsilon = 1e-10);
    }
    ...
    fn test_newton_interpolate_linear() {
        ...
        // Test at known points
        assert_relative_eq!(newton_interpolate(0.0, &x_vals, &coef), 1.0, epsilon = 1e-10);
        assert_relative_eq!(newton_interpolate(1.0, &x_vals, &coef), 3.0, epsilon = 1e-10);

        // Test interpolation and extrapolation
        assert_relative_eq!(newton_interpolate(0.5, &x_vals, &coef), 2.0, epsilon = 1e-10);
        assert_relative_eq!(newton_interpolate(2.0, &x_vals, &coef), 5.0, epsilon = 1e-10);
    }
    ...
    fn test_newton_interpolate_quadratic() {
        ...
        // Test at known points
        assert_relative_eq!(newton_interpolate(0.0, &x_vals, &coef), 1.0, epsilon = 1e-10);
        assert_relative_eq!(newton_interpolate(1.0, &x_vals, &coef), 0.0, epsilon = 1e-10);
        assert_relative_eq!(newton_interpolate(2.0, &x_vals, &coef), 1.0, epsilon = 1e-10);

        // Test interpolation
        assert_relative_eq!(newton_interpolate(0.5, &x_vals, &coef), 0.25, epsilon = 1e-10);
        assert_relative_eq!(newton_interpolate(1.5, &x_vals, &coef), 0.25, epsilon = 1e-10);
    }
    ...
    fn test_single_point_interpolation() {
        ...
        assert_relative_eq!(lagrange_interpolate(0.0, &x_vals, &y_vals), 5.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(1.0, &x_vals, &y_vals), 5.0, epsilon = 1e-10);
        assert_relative_eq!(lagrange_interpolate(10.0, &x_vals, &y_vals), 5.0, epsilon = 1e-10);

        assert_relative_eq!(newton_interpolate(0.0, &x_vals, &coef), 5.0, epsilon = 1e-10);
        assert_relative_eq!(newton_interpolate(1.0, &x_vals, &coef), 5.0, epsilon = 1e-10);
        assert_relative_eq!(newton_interpolate(10.0, &x_vals, &coef), 5.0, epsilon = 1e-10);
    }
