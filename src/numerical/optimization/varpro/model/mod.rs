use crate::numerical::optimization::varpro::model::errors::ModelError;
    ...
    DefaultAllocator: nalgebra::allocator::Allocator<Dyn, Dyn>,
{
    ...
    /// Return the ordered names of the nonlinear parameters.
    ///
    /// The order must match the order used by [`params`](SeparableNonlinearModel::params)
    /// and by the nonlinear solver state.
    fn parameter_names(&self) -> &[String];
