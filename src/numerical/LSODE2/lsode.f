...
c                             of the internal common blocks used by
c                             lsode.  presumes a prior call to svcom
...
c vnorx routine (see below), and also used by lsode in the computation
...
c vnorx is called with n = neq and with w(i) = 1.0/ewt(i), where
c ewt is as set by subroutine ewset.
c
c if the user supplies this function, it should return a non-negative
c value of vnorx suitable for use in the error control in lsode.
c none of the arguments should be altered by vnorx.
c for example, a user-supplied vnorx routine might..
...
c  vnorx    computes the weighted r.m.s. norm of a vector.
...
c note..  vnorx, idamax, ddot, and d1mach are function routines.
...
c-----------------------------------------------------------------------
 ...
 160  tol = dmax1(tol,100.0d0*uround)
      ...
      sum = vnorx (n, rwork(lf0), rwork(lewt))
...
c-----------------------------------------------------------------------
 ...
 270  tolsf = uround*vnorx (n, rwork(lyh), rwork(lewt))
 ...
 280  if ((tn + h) .ne. tn) go to 290
      ...
      call xerrwx(50hlsode--  warning..internal t (=r1) and h (=r2) are,
     ...
     1   50, 101, 1, 0, 0, 0, 2, tn, h)
      ...
      call xerrwx(50hlsode--  above warning has been issued i1 times.  ,
...
c the maximum number of steps was taken before reaching tout. ----------
 500  call xerrwx(50hlsode--  at current t (=r1), mxstep (=i1) steps   ,
...
c ewt(i) .le. 0.0 for some i (not at start of problem). ----------------
 510  ewti = rwork(lewt+i-1)
      call xerrwx(50hlsode--  at t (=r1), ewt(i1) has become r2 .le. 0.,
     1   50, 202, 1, 1, i, 0, 2, tn, ewti)
      istate = -6
      go to 580
c too much accuracy requested for machine precision. -------------------
 520  call xerrwx(50hlsode--  at t (=r1), too much accuracy requested  ,
...
c kflag = -1.  error test failed repeatedly or with abs(h) = hmin. -----
 530  call xerrwx(50hlsode--  at t(=r1) and step size h(=r2), the error,
...
c kflag = -2.  convergence failed repeatedly or with abs(h) = hmin. ----
 540  call xerrwx(50hlsode--  at t (=r1) and step size h (=r2), the    ,
...
c the run is halted.
c-----------------------------------------------------------------------
 601  call xerrwx(30hlsode--  istate (=i1) illegal ,
     1   30, 1, 1, 1, istate, 0, 0, 0.0d0, 0.0d0)
      go to 700
 602  call xerrwx(30hlsode--  itask (=i1) illegal  ,
     1   30, 2, 1, 1, itask, 0, 0, 0.0d0, 0.0d0)
      go to 700
 603  call xerrwx(50hlsode--  istate .gt. 1 but lsode not initialized  ,
     1   50, 3, 1, 0, 0, 0, 0, 0.0d0, 0.0d0)
      go to 700
 604  call xerrwx(30hlsode--  neq (=i1) .lt. 1     ,
     1   30, 4, 1, 1, neq(1), 0, 0, 0.0d0, 0.0d0)
      go to 700
 605  call xerrwx(50hlsode--  istate = 3 and neq increased (i1 to i2)  ,
     1   50, 5, 1, 2, n, neq(1), 0, 0.0d0, 0.0d0)
      go to 700
 606  call xerrwx(30hlsode--  itol (=i1) illegal   ,
     1   30, 6, 1, 1, itol, 0, 0, 0.0d0, 0.0d0)
      go to 700
 607  call xerrwx(30hlsode--  iopt (=i1) illegal   ,
     1   30, 7, 1, 1, iopt, 0, 0, 0.0d0, 0.0d0)
      go to 700
 608  call xerrwx(30hlsode--  mf (=i1) illegal     ,
     1   30, 8, 1, 1, mf, 0, 0, 0.0d0, 0.0d0)
      go to 700
 609  call xerrwx(50hlsode--  ml (=i1) illegal.. .lt.0 or .ge.neq (=i2),
     1   50, 9, 1, 2, ml, neq(1), 0, 0.0d0, 0.0d0)
      go to 700
 610  call xerrwx(50hlsode--  mu (=i1) illegal.. .lt.0 or .ge.neq (=i2),
     1   50, 10, 1, 2, mu, neq(1), 0, 0.0d0, 0.0d0)
      go to 700
 611  call xerrwx(30hlsode--  maxord (=i1) .lt. 0  ,
     1   30, 11, 1, 1, maxord, 0, 0, 0.0d0, 0.0d0)
      go to 700
 612  call xerrwx(30hlsode--  mxstep (=i1) .lt. 0  ,
     1   30, 12, 1, 1, mxstep, 0, 0, 0.0d0, 0.0d0)
      go to 700
 613  call xerrwx(30hlsode--  mxhnil (=i1) .lt. 0  ,
     1   30, 13, 1, 1, mxhnil, 0, 0, 0.0d0, 0.0d0)
      go to 700
 614  call xerrwx(40hlsode--  tout (=r1) behind t (=r2)      ,
     1   40, 14, 1, 0, 0, 0, 2, tout, t)
      call xerrwx(50h      integration direction is given by h0 (=r1)  ,
     1   50, 14, 1, 0, 0, 0, 1, h0, 0.0d0)
      go to 700
 615  call xerrwx(30hlsode--  hmax (=r1) .lt. 0.0  ,
     1   30, 15, 1, 0, 0, 0, 1, hmax, 0.0d0)
      go to 700
 616  call xerrwx(30hlsode--  hmin (=r1) .lt. 0.0  ,
 ...
 618  call xerrwx(
     ...
     1   60, 18, 1, 2, leniw, liw, 0, 0.0d0, 0.0d0)
      go to 700
 619  call xerrwx(40hlsode--  rtol(i1) is r1 .lt. 0.0        ,
     1   40, 19, 1, 1, i, 0, 1, rtoli, 0.0d0)
      go to 700
 620  call xerrwx(40hlsode--  atol(i1) is r1 .lt. 0.0        ,
     1   40, 20, 1, 1, i, 0, 1, atoli, 0.0d0)
      go to 700
 621  ewti = rwork(lewt+i-1)
      call xerrwx(40hlsode--  ewt(i1) is r1 .le. 0.0         ,
 ...
 625  call xerrwx(
     ...
     1   60, 25, 1, 0, 0, 0, 2, tcrit, tout)
      go to 700
 626  call xerrwx(50hlsode--  at start of problem, too much accuracy   ,
     ...
     1   60, 26, 1, 0, 0, 0, 1, tolsf, 0.0d0)
      rwork(14) = tolsf
      go to 700
 627  call xerrwx(50hlsode--  trouble from intdy. itask = i1, tout = r1,
...
c
 700  if (illin .eq. 5) go to 710
      ...
      istate = -3
      return
 710  call xerrwx(50hlsode--  repeated occurrences of illegal input    ,
     1   50, 302, 1, 0, 0, 0, 0, 0.0d0, 0.0d0)
c
 800  call xerrwx(50hlsode--  run aborted.. apparent infinite loop     ,
