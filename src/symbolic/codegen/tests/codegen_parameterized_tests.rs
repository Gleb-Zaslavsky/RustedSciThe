...
use crate::symbolic::codegen::codegen_adapters::{
    dense_ir_blocks, dense_runtime_plan, residual_ir_blocks,
};
...
use crate::symbolic::codegen::testing_fixtures::test_codegen_generated_parameterized_dense_fixtures::generated_parameterized_dense_fixture;
...
fn bind_parameterized_residual_fixture_chunks<'a>(
    ...
    let chunk_fns: Vec<crate::symbolic::codegen::codegen_orchestrator::GeneratedChunkFn> =
