...
use crate::symbolic::codegen::testing_fixtures::test_codegen_generated_dense_fixtures::generated_dense_fixture;
...
fn bind_dense_residual_fixture_chunks<'a>(
    ...
    let chunk_fns = [
        generated_dense_fixture::fixture_dense_residual_chunk_0
            as crate::symbolic::codegen::codegen_orchestrator::GeneratedChunkFn,
